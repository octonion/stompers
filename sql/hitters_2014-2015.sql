...
ps.class_year,
ps.position,
coalesce(ps.ab,0)+coalesce(ps.bb,0)+coalesce(ps.hbp,0)+coalesce(ps2.ab,0)+coalesce(ps2.bb,0)+coalesce(ps2.hbp,0) as pa,

(
(coalesce(ps.h,0)+coalesce(ps.bb,0)+coalesce(ps.hbp,0)+coalesce(ps2.h,0)+coalesce(ps2.bb,0)+coalesce(ps2.hbp,0))::float/(coalesce(ps.ab,0)+coalesce(ps.bb,0)+coalesce(ps.hbp,0)+coalesce(ps2.ab,0)+coalesce(ps2.bb,0)+coalesce(ps2.hbp,0))
)::numeric(4,3) as obp,
...
+coalesce(ps2.h,0)+coalesce(ps2.d,0)+2*coalesce(ps2.t,0)+3*coalesce(ps2.hr,0)
)::float
/(coalesce(ps.ab,0)+coalesce(ps2.ab,0)))::numeric(4,3) as slg,

((
coalesce(ps.h,0)+coalesce(ps.d,0)+2*coalesce(ps.t,0)+3*coalesce(ps.hr,0)
+coalesce(ps2.h,0)+coalesce(ps2.d,0)+2*coalesce(ps2.t,0)+3*coalesce(ps2.hr,0)
)::float
/(coalesce(ps.ab,0)+coalesce(ps2.ab,0))
...
left join ncaa_pbp.player_summaries_hitting ps2
...
to '/tmp/hitters_2014-2015.csv' csv header;
